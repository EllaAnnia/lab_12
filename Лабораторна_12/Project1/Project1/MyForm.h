...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			this->textBox1->Location = System::Drawing::Point(189, 127);
			...
			this->textBox2->Location = System::Drawing::Point(189, 163);
			...
			this->textBox3->Location = System::Drawing::Point(354, 122);
			this->textBox3->Multiline = true;
			this->textBox3->Name = L"textBox3";
			this->textBox3->Size = System::Drawing::Size(324, 350);
			...
			this->button1->Location = System::Drawing::Point(14, 308);
			...
			this->button2->Font = (gcnew System::Drawing::Font(L"Microsoft Sans Serif", 10.2F, System::Drawing::FontStyle::Bold, System::Drawing::GraphicsUnit::Point,
				static_cast<System::Byte>(204)));
			this->button2->Location = System::Drawing::Point(166, 308);
			this->button2->Name = L"button2";
			this->button2->Size = System::Drawing::Size(128, 52);
			...
			this->label1->Font = (gcnew System::Drawing::Font(L"Microsoft Sans Serif", 10.8F, System::Drawing::FontStyle::Bold, System::Drawing::GraphicsUnit::Point,
				static_cast<System::Byte>(204)));
			this->label1->Location = System::Drawing::Point(10, 127);
			this->label1->Name = L"label1";
			this->label1->Size = System::Drawing::Size(173, 22);
			this->label1->TabIndex = 5;
			this->label1->Text = L"Перший член b0=";
			// 
			// label2
			// 
			...
			this->label2->Font = (gcnew System::Drawing::Font(L"Microsoft Sans Serif", 10.8F, System::Drawing::FontStyle::Bold, System::Drawing::GraphicsUnit::Point,
				static_cast<System::Byte>(204)));
			this->label2->Location = System::Drawing::Point(42, 161);
			this->label2->Name = L"label2";
			this->label2->Size = System::Drawing::Size(141, 22);
			this->label2->TabIndex = 6;
			this->label2->Text = L"Знаменник q=";
			// 
			// textBox4
			// 
			...
			this->textBox4->Font = (gcnew System::Drawing::Font(L"Times New Roman", 13.8F, System::Drawing::FontStyle::Regular, System::Drawing::GraphicsUnit::Point,
				static_cast<System::Byte>(204)));
			this->textBox4->Location = System::Drawing::Point(14, 12);
			this->textBox4->Multiline = true;
			this->textBox4->Name = L"textBox4";
			this->textBox4->Size = System::Drawing::Size(630, 80);
			this->textBox4->TabIndex = 7;
			this->textBox4->Text = L"7. Перший член і знаменник зростаючої геометричної прогресії дорівнюють відповідн"
				L"о b0 і q. Виведіть десять перших членів прогресії.";
			// 
			// MyForm
			// 
			...
			this->Name = L"MyForm";
			this->Text = L"Зростаюча геометрична прогресія";
...
#pragma endregion
	private: System::Void button1_Click(System::Object^ sender, System::EventArgs^ e) 
	{
		int i;
		double d0, q;
		d0 = Convert::ToDouble(textBox1->Text);
		q = Convert::ToDouble(textBox2->Text);
		if (q>1)
		{
			textBox3->AppendText("Перші 10 членів зростаючої геометричної прогресії\r\n");
			textBox3->AppendText(Convert::ToString(d0) + "\r\n");
			for (i = 1; i <= 9; i++)
			{
				d0 = d0 * q;
				textBox3->AppendText(Convert::ToString(d0) + "\r\n");
